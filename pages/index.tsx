...
const Home = () => {
  ...
  const renderSpotifyPlayer = () => {
    ...
    if (window.screen.width < 1130) return getCompactPlayer();
    return getNormalPlayer();
  };

  const getCompactPlayer = () => (
    <div className={styles.spotifyPlaylistContainer}>
      <SpotifyPlayer height='80' src={selectedPlaylist} />
